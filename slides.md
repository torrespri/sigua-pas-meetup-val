...
### Utilidades de apoyo
> <span "fa-stack fa-lg"><i class= "fa-circle fa-stack 2x"></i><i class="fa fa-lightbulb-o fa-stack 1x"></i></span> Cualquier usuario autentificado puede enviar a su Gestor SIGUA el código de la estancia en que desempeña su puesto enlazándola en el mapa: `Ver estancia` > diálogo `Ficha estancia` > `Autoubica`

> <span "fa-stack fa-lg"><i class= "fa-circle fa-stack 2x"></i><i class="fa fa-lightbulb-o fa-stack 1x"></i></span> El Gestor SIGUA puede localizar todas las estancias de su unidad organizativa desde <i class="fa fa-user fa-user-gold"></i> > `Ver estancias` > diálogo `Mis estancias`
